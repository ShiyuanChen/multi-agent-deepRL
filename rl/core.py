...
class Agent(object):
    ...
    def fit(self, env, nb_steps, action_repetition=1, callbacks=None, tensorboard=None, verbose=1,
            visualize=False, nb_max_start_steps=0, start_step_policy=None, log_interval=10000,
            episode_log_freq=20, nb_max_episode_steps=None):
        ...
        try:
            while self.step < nb_steps:
                ...
                if done:
                    ...
                    if episode % episode_log_freq == 0:
                        episode_rewards = np.array(episode_rewards)
                        episode_length = np.array(episode_length)
                        episode_logs_tensorboard = {
                        ...
                        tensorboard.on_epoch_end(episode, episode_logs_tensorboard)
